...
* [ ] Seed the database
  * [ ] A data.sql file has been provided with seed data. You can use this class directly or modify it to fit your com.lambdaschool.javaorder.models. However, the data found in the file is the seed data to use!
  * [ ] A SeedData.java file has been provided seed data. You can use this class directly or modify it to fit your com.lambdaschool.javaorder.models. However, the data found in the file is the seed data to use!
